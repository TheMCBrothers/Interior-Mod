...
public class InteriorAdvancementProvider extends ForgeAdvancementProvider {

    public InteriorAdvancementProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, ExistingFileHelper existingFileHelper) {
