...
public class InteriorAdvancementProvider extends AdvancementProvider {
    ...
    protected void registerAdvancements(Consumer<Advancement> consumer, ExistingFileHelper fileHelper) {
        ...
        Advancement.Builder.advancement().display(this.furnitureWithType(FurnitureType.CHAIR, FurnitureMaterials.CRIMSON_PLANKS), this.title("chair"), this.description("chair"), null, FrameType.TASK, true, true, false).addCriterion("chair", InventoryChangeTrigger.TriggerInstance.hasItems(InteriorBlocks.CHAIR.get())).parent(advancement).save(consumer, this.id("chair"), fileHelper);
        Advancement.Builder.advancement().display(this.furnitureWithType(FurnitureType.TABLE, FurnitureMaterials.WARPED_PLANKS), this.title("table"), this.description("table"), null, FrameType.TASK, true, true, false).addCriterion("table", InventoryChangeTrigger.TriggerInstance.hasItems(InteriorBlocks.TABLE.get())).parent(advancement).save(consumer, this.id("table"), fileHelper);
        Advancement.Builder.advancement().display(InteriorBlocks.FRIDGE.get(), this.title("fridge"), this.description("fridge"), null, FrameType.TASK, true, true, false).addCriterion("fridge", InventoryChangeTrigger.TriggerInstance.hasItems(InteriorBlocks.FRIDGE.get())).parent(advancement).save(consumer, this.id("fridge"), fileHelper);
        Advancement advancement1 = Advancement.Builder.advancement().display(InteriorBlocks.LAMP.get(), this.title("lamp"), this.description("lamp"), null, FrameType.TASK, true, true, false).addCriterion("lamp", InventoryChangeTrigger.TriggerInstance.hasItems(InteriorBlocks.LAMP.get())).parent(advancement).save(consumer, this.id("lamp"), fileHelper);
        Advancement.Builder.advancement().display(InteriorBlocks.LAMP_ON_A_STICK.get(), this.title("lamp_on_a_stick"), this.description("lamp_on_a_stick"), null, FrameType.TASK, true, true, false).addCriterion("lamp_on_a_stick", PlacedBlockTrigger.TriggerInstance.placedBlock(InteriorBlocks.LAMP_ON_A_STICK.get())).parent(advancement1).save(consumer, this.id("lamp_on_a_stick"), fileHelper);
        Advancement.Builder.advancement().display(InteriorBlocks.TRASH_CAN.get(), this.title("trash_can"), this.description("trash_can"), null, FrameType.TASK, true, true, false).addCriterion("trash_can", PlacedBlockTrigger.TriggerInstance.placedBlock(InteriorBlocks.TRASH_CAN.get())).parent(advancement).save(consumer, this.id("trash_can"), fileHelper);
        Advancement.Builder.advancement().display(InteriorBlocks.MODERN_DOOR.get(), this.title("modern_door"), this.description("modern_door"), null, FrameType.TASK, true, true, false).addCriterion("modern_door", InventoryChangeTrigger.TriggerInstance.hasItems(InteriorBlocks.MODERN_DOOR.get())).parent(advancement).save(consumer, this.id("modern_door"), fileHelper);
    }
