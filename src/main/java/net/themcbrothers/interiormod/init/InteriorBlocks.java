...
public class InteriorBlocks {
    ...
    public static final RegistryObject<DoorBlock> MODERN_DOOR = BLOCKS.register("modern_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.STONE, DyeColor.WHITE).strength(2.5f).sound(SoundType.STONE).dynamicShape(), BlockSetType.CHERRY));
