...
public enum WoodType implements IStringSerializable {
	...
	MAGIC("magic", new ResourceLocation("biomesoplenty", "magic_planks")),
	MAHOGANY("mahogany", new ResourceLocation("biomesoplenty", "mahogany_planks")),
	PALM("palm", new ResourceLocation("biomesoplenty", "palm_planks")),
	REDWOOD("redwood", new ResourceLocation("biomesoplenty", "redwood_planks")),
	UMBRAN("umbran", new ResourceLocation("biomesoplenty", "umbran_planks")),
	WILLOW("willow", new ResourceLocation("biomesoplenty", "willow_planks")),
	USELESS("useless", new ResourceLocation("uselessmod", "useless_planks"));
	...
	static {
		...
		BY_SUBTYPE.get(SubType.USELESS).add(USELESS);
	...
	public enum SubType implements IStringSerializable {
		VANILLA("vanilla"), BOP("bop"), USELESS("useless");
