...
public class CustomShapedRecipeBuilder {
    ...
    public CustomShapedRecipeBuilder(ItemStack resultIn) {
     ...
     */
    public static CustomShapedRecipeBuilder shapedRecipe(ItemStack resultIn) {
        return new CustomShapedRecipeBuilder(resultIn);
    }
    ...
    public void build(Consumer<IFinishedRecipe> consumerIn, ResourceLocation id) {
        ...
        consumerIn.accept(new Result(id, this.result, this.group == null ? "" : this.group, this.pattern, this.key, this.advancementBuilder, new ResourceLocation(id.getNamespace(), "recipes/" + Objects.requireNonNull(this.result.getItem().getGroup()).getPath() + "/" + id.getPath())));
    }
